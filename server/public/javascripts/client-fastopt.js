...
/** @constructor */
function $c_Lwin_nathan_WebApp$() {
  $c_O.call(this)
}
$c_Lwin_nathan_WebApp$.prototype = new $h_O();
$c_Lwin_nathan_WebApp$.prototype.constructor = $c_Lwin_nathan_WebApp$;
/** @constructor */
function $h_Lwin_nathan_WebApp$() {
  /*<skip>*/
}
$h_Lwin_nathan_WebApp$.prototype = $c_Lwin_nathan_WebApp$.prototype;
$c_Lwin_nathan_WebApp$.prototype.init___ = (function() {
  return this
});
$c_Lwin_nathan_WebApp$.prototype.fun__V = (function() {
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().alert("asds")
});
$c_Lwin_nathan_WebApp$.prototype.$$js$exported$meth$fun__O = (function() {
  this.fun__V()
});
$c_Lwin_nathan_WebApp$.prototype.fun = (function() {
  return this.$$js$exported$meth$fun__O()
});
var $d_Lwin_nathan_WebApp$ = new $TypeData().initClass({
  Lwin_nathan_WebApp$: 0
}, false, "win.nathan.WebApp$", {
  Lwin_nathan_WebApp$: 1,
  O: 1
});
$c_Lwin_nathan_WebApp$.prototype.$classData = $d_Lwin_nathan_WebApp$;
var $n_Lwin_nathan_WebApp$ = (void 0);
function $m_Lwin_nathan_WebApp$() {
  if ((!$n_Lwin_nathan_WebApp$)) {
    $n_Lwin_nathan_WebApp$ = new $c_Lwin_nathan_WebApp$().init___()
  };
  return $n_Lwin_nathan_WebApp$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$e.win = ($e.win || {});
$e.win.nathan = ($e.win.nathan || {});
$e.win.nathan.WebApp = $m_Lwin_nathan_WebApp$;
}).call(this);
